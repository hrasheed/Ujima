      ...
      <!--Form Section--->
        <section class="contact-form">
            ...
            <div class="form-box" id="form">
                       ...
                       <?php
                             if($_GET['success']==1){
                                 echo"<div class=\"form-messages-success\">Thank You <b>Message sent</div>";
                             }
                             
                              if($_GET['success']==-1){
                                 echo"<div class=\"form-messages-failure\">Thank You <br> Please Try Again</div>";
                             }
                     ...
                     <input type ="number" "age" id="age" required min="18" max="100">
                     </div>

                    <div>
                     <label for="shipping-address-1">Shipping Address</label>
                     <input name="shipping-address-1" id="shipping-address-1" required>
                        <div>
                        <label for="shipping-address-2">Unit #</label>
                        <input name="shipping-address-2" required>
                     </div>
                        </div>
